...
<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(16,185,129,0.30),transparent_70%)]" />
      ...
      <motion.div className="relative z-10 px-4 sm:px-8 lg:px-10 py-16 md:py-20 flex flex-col items-center text-center spaace-y-6"
...
<div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from[#0d58cc] via-cyan-300 to-emerald-400 mt-3"/>
...
<p className="text-gray-300 italic max-w-xl mt-4">
  “Success is when preparation meets opportunity.”
</p>

<p className="text-xs text-gray-400 mt-4">
  &copy; {new Date().getFullYear()} Ayush Sengar. All rights reserved.
</p>
      </motion.div>
