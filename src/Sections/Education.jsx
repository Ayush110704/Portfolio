...
const experiences = [
  {
    role: "Java Fukk-Stack Web development",
    company: "ItVedant Java Full-Stack Web development",
    duration: "2022",
    description: " have completed this full-stack web development course from ItVedant where I learned various technologies like HTML, CSS, JavaScript, ReactJS, NodeJS, ExpressJS, MongoDB, etc.",
  },
  {
    role: "B.Sc(CS) Rashtrasant Tukadoji Maharaj Nagpur University", 
    duration: "2023-2026",
    description: "Completed my Bachelor of Science(CS) from RTMNU with a first-class grade.",
  },
  {
    role: "(XII)-General Science",
    company: "From Pune Board",
    duration: "2024 - 2025",
    description: " Completed 12th From Baja Collage Of Science A well known Collage from Wardha.",
  },
];
...
function ExperienceItem({exp , idx , start , end , scrollYProgress , layout}){
  ...
  return(
    <div className="relative flex flex-1 justify-center items-center min-w-0">
      <motion.div className="z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.1)]"
        style={{scale , opacity}}
        >
      </motion.div>
...
return(
  <div className="relative flex items-start">
    <motion.div className="absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.1)]"
      style={{scale , opacity}}
    >
