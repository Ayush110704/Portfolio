...
const x=useMotionValue(0); // abhi hum kis posotion pe hai  from smooth motion
...
useEffect (()=> {
  ...
  [entry]) => {
    setActive(entry.isIntersecting && entry.intersectionRatio >=0.1); // ye check kr ta hai ki viewport me visible hai ya nhi boolean bata ta agar hai toh true de ga jab true ho toh check kare ge skill section 10% se visssable ho tab start kare ga 
  },
{threshold:[0.1]}
)
io.observe(el);
...
className="h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
  ...
  <motion.h2 className='text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302663] z-10'
