...
const socials = [
  {Icon: FaLinkedin, label: "LinkedIn", href:"https://www.linkedin.com/in/ayush-sengar-9273b5232/"},
   {Icon: FaGithub, label: "GitHub", href:"https://github.com/AyushSengar2003"}
...
const roles = useMemo(() =>["Full Stack Developer", "MERN Stack Developer", "Frontend Developer"],[])
...
if(!deleting && subindex === current.length)setTimeout(() => setDeleting(true), 1200); // 
else if(deleting && subindex >0)setSubindex (v => v - 1); //
else if(deleting && subindex ===0){ setDeleting(false); setIndex (v => (v + 1) % roles.length); }

} , deleting ? 40 : 60)

return () => clearTimeout(timeout);// kab unmout animation ko clear kr de ga next timme jab dubara sapce me aaye toh 2 timer na chale rahe ho koi bug na aaye 
      ...
      <ParticleBackground />
       <div className="absolute inset-0 relative">
        <div
          ...
          rounded-full
          bg-gradient-to-tr from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
...
<span className="inline-block w-[2px] ml-1 bg-white animate-pulse slign-middle "
style={{height:"1em"}}
>
...
<motion.div className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-7"
initial={{ opacity:0}}
animate={{ opacity:1}}
